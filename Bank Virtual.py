...
st.markdown(
    ...
    .stApp {
        ...
        background-size: 890px; /* Mengatur ukuran gambar latar belakang */
    }
    ...
    h1 {
        ...
        font-size: 77px;
        margin-bottom: 20px; 
        background-image: url('https://img.freepik.com/premium-vector/financial-growth-concept-young-businessman-earn-more-profit-make-money-from-cryptocurrency_746655-10737.jpg')
    }
